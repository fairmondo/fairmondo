...
describe BusinessTransactionMailer do
  ...
  it "should notify the seller properly" do
    ...
    mail.must have_body_text(I18n.t('transaction.notifications.greeting') + business_transaction.article_seller_forename + ',')
  ...
  it "should notify the buyer" do
    ...
    mail.must have_body_text(I18n.t('transaction.notifications.greeting') + business_transaction.buyer_forename + ',')
