...
describe BusinessTransactionMailerHelper do
  ...
  describe "#show_buyer_address( business_transaction )" do
    it "should return the right shipping_address for the buyer" do
      address = helper.show_buyer_address( @business_transaction.shipping_address )
      address.must_contain( @business_transaction.shipping_address.title )
      address.must_contain( @business_transaction.shipping_address.first_name )
      address.must_contain( @business_transaction.shipping_address.last_name )
      address.must_contain( @business_transaction.shipping_address.address_line_1 )
      address.must_contain( @business_transaction.shipping_address.address_line_2 )
      address.must_contain( @business_transaction.shipping_address.city )
      address.must_contain( @business_transaction.shipping_address.zip )
      address.must_contain( @business_transaction.shipping_address.country )
    end
  end

  describe "#show_buyer_address( business_transaction )" do
    it "should return the right billing_address for the buyer" do
      address = helper.show_buyer_address( @business_transaction.billing_address )
      address.must_contain( @business_transaction.billing_address.title )
      address.must_contain( @business_transaction.billing_address.first_name )
      address.must_contain( @business_transaction.billing_address.last_name )
      address.must_contain( @business_transaction.billing_address.address_line_1 )
      address.must_contain( @business_transaction.billing_address.address_line_2 )
      address.must_contain( @business_transaction.billing_address.city )
      address.must_contain( @business_transaction.billing_address.zip )
      address.must_contain( @business_transaction.billing_address.country )
    end
  end
