...
NOTE: As long as the official repo for the analysis plugin is down you can use this url: http://www.smallbutton.com/system/elasticsearch-analysis-german-1.3.2.5-plugin.zip see https://github.com/jprante/elasticsearch-analysis-german/issues/2
