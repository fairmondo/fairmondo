...
curl -k -L -o elasticsearch.tar.gz https://download.elasticsearch.org/elasticsearch/elasticsearch/elasticsearch-0.90.3.tar.gz
    tar -zxvf elasticsearch.tar.gz
    ./elasticsearch/bin/plugin --install decompound --url http://bit.ly/1hmvN6Z
