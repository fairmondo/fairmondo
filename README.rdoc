...
{<img src="https://travis-ci.org/fairnopoly/fairnopoly.png" />}[https://travis-ci.org/fairnopoly/fairnopoly] {<img src="https://coveralls.io/repos/fairnopoly/fairnopoly/badge.png?branch=release" alt="Coverage Status" />}[https://coveralls.io/r/fairnopoly/fairnopoly?branch=release] {<img src="https://codeclimate.com/github/fairnopoly/fairnopoly.png" />}[https://codeclimate.com/github/fairnopoly/fairnopoly]
...
If you are not sure how to _install Ruby and the Ruby on Rails framework_ on your computer, have a look at Michael Hartl's excellent {tutorial}[http://ruby.railstutorial.org/ruby-on-rails-tutorial-book#sec-rubygems] on the subject.

Make sure you install _ruby 1.9.3_ and not 2.0.0.

=== Fairnopoly Project Setup (automated)

Note: the automated process won't work under Windows.
To run Fairnopoly locally in development mode, install ruby and rails. Then open up a console and **copy & paste** in the following line:
