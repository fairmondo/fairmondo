...
describe TransactionMailer do
  ...
  context "seller notification" do
    ...
    it "should be delivered to seller email" do
      should deliver_to( transaction.seller.email )
    end

    it "should have right subject" do
      should have_subject("[Fairnopoly] " + I18n.t('transaction.notifications.seller.seller_subject') + " (#{transaction.article_title})")
    end
    ...
    it "should contain the buyer's email address" do
      should have_body_text(transaction.buyer.email)
    end
  end
  ...
  context "buyer notification" do
    ...
    it "should be delivererd to buyer email" do
      should deliver_to( transaction.buyer_email )
    end

    it "should have the right subject" do
      should have_subject("[Fairnopoly] " + I18n.t('transaction.notifications.buyer.buyer_subject') + " (#{transaction.article_title})")
    end
    ...
    it "should contain seller's email address" do
      should have_body_text( transaction.seller.email )
    end

    it "should contain title of article" do
      should have_body_text( transaction.article_title )
    end

    it "should contain link to article" do
      should have_body_text( "/articles/#{transaction.article.slug}" )
    end

    it "should contain link to transaction" do
      should have_body_text( "transactions/#{transaction.id}" )
    end

    # it "should contain string: Bitte gib bei..." do
    #   should have_body_text( I18n.t( 'transaction.notifications.buyer.transaction_id_info', id: transaction.id ) )
    # end

    # it "should contain transaction id" do
    #   should have_body_text( transaction.id )
    # end
