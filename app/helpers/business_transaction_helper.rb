...
#
module BusinessTransactionHelper
  ...
  def display_selected_payment selected_payment
    tablerow(
      ...
      t("enumerize.business_transaction.selected_payment.#{selected_payment}")
    )
  end
  ...
  def display_selected_transport selected_transport
    tablerow(
      ...
      t("enumerize.business_transaction.selected_transport.#{selected_transport}")
    )
  end
  ...
  def display_optional_warning selected_transport, selected_payment
    if selected_transport == 'pickup' && selected_payment != 'cash' && resource.selected?('payment', 'cash')
      '<p class="warning warning--small warning--red"><small>'.html_safe +
