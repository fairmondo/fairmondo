class Exhibit < ActiveRecord::Base
  ...
  scope :article_active, where(" articles.state = 'active' ").includes(:article)
  scope :related_article_active, where("related_articles_exhibits.state = 'active' ").includes(:related_article)
end
