...
module ArticleConcerns
  module ActiveRecordOverwrites
    ...
    included do
      ...
      alias_method :quantity_available_without_article_state, :quantity_available
      alias_method :quantity_available, :quantity_available_with_article_state
    end
