    ...
    $.fn.socialSharePrivacy = function (settings) {
        ...
        return this.each(function () {
            ...
            if (facebook_on) {
                ...
                context.append('<li class="facebook help_info"><span class="info">' + options.services.facebook.txt_info + '</span><span class="switch fa fa-lock"></span><div class="fb_like dummy_btn">' + fb_dummy_btn + '</div></li>');
                ...
                $('li.facebook i,li.facebook span.switch', context).on('click', function () {
                    if ($container_fb.find('span.switch').hasClass('fa-lock')) {
                        ...
                        $container_fb.find('span.switch').addClass('fa-unlock-alt').removeClass('fa-lock');
                        $container_fb.find('#facebook-dummy').replaceWith(fb_code);
                    } else {
                        $container_fb.removeClass('info_off');
                        $container_fb.find('span.switch').addClass('fa-lock').removeClass('fa-unlock-alt');
            ...
            if (twitter_on) {
                ...
                context.append('<li class="twitter help_info"><span class="info">' + options.services.twitter.txt_info + '</span><span class="switch fa fa-lock"></span><div class="tweet dummy_btn">' + twitter_dummy_btn + '</div></li>');
                ...
                $('li.twitter i,li.twitter span.switch', context).on('click', function () {
                    if ($container_tw.find('span.switch').hasClass('fa-lock')) {
                        ...
                        $container_tw.find('span.switch').addClass('fa-unlock-alt').removeClass('fa-lock');
                        $container_tw.find('#twitter-dummy').replaceWith(twitter_code);
                    } else {
                        $container_tw.removeClass('info_off');
                        $container_tw.find('span.switch').addClass('fa-lock').removeClass('fa-unlock-alt');
            ...
            if (gplus_on) {
                ...
                context.append('<li class="gplus help_info"><span class="info">' + options.services.gplus.txt_info + '</span><span class="switch fa fa-lock"></span><div class="gplusone dummy_btn">' + gplus_dummy_btn + '</div></li>');
                ...
                $('li.gplus i,li.gplus span.switch', context).on('click', function () {
                    if ($container_gplus.find('span.switch').hasClass('fa-lock')) {
                        ...
                        $container_gplus.find('span.switch').addClass('fa-unlock-alt').removeClass('fa-lock');
                        $container_gplus.find('#gplusone-dummy').replaceWith(gplus_code);
                    } else {
                        $container_gplus.removeClass('info_off');
                        $container_gplus.find('span.switch').addClass('fa-lock').removeClass('fa-unlock-alt');
            ...
            if (pinterest_on) {
                ...
                context.append('<li class="pinterest help_info"><span class="info">' + options.services.pinterest.txt_info + '</span><span class="switch fa fa-lock"></span><div class="pinterest dummy_btn">' + pinterest_dummy_btn + '</div></li>');
                ...
                $('li.pinterest i,li.pinterest span.switch', context).on('click', function () {
                    if ($container_pinterest.find('span.switch').hasClass('fa-lock')) {
                        ...
                        $container_pinterest.find('span.switch').addClass('fa-unlock-alt').removeClass('fa-lock');
                       ...
                       document.getElementsByTagName('head')[0].appendChild(pinterest_script);
                        ...
                        $container_pinterest.find('span.switch').addClass('fa-lock').removeClass('fa-unlock-alt');
