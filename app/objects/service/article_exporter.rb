    ...
    determine_articles_to_export( user, params ).find_each do |item|
      ...
      if item.is_a? BusinessTransaction
        ...
        transaction_attrs = { "transport_provider" => item.selected_transport_provider,
                                    ...
                                    'shipping_address_title' => item.shipping_address_title,
                                    'shipping_address_first_name' => item.shipping_address_first_name,
                                    'shipping_address_last_name' => item.shipping_address_last_name,
                                    'shipping_address_company_name' => item.shipping_address_company_name,
                                    'shipping_address_address_line_1' => item.shipping_address_address_line_1,
                                    'shipping_address_address_address_line_2' => item.shipping_address_address_line_2,
                                    'shipping_address_zip' => item.shipping_address_zip,
                                    'shipping_address_city' => item.shipping_address_city,
                                    'shipping_address_country' => item.shipping_address_country,
                                    'billing_address_title' => item.billing_address_title,
                                    'billing_address_first_name' => item.billing_address_first_name,
                                    'billing_address_last_name' => item.billing_address_last_name,
                                    'billing_address_company_name' => item.billing_address_company_name,
                                    'billing_address_address_line_1' => item.billing_address_address_line_1,
                                    'billing_address_address_address_line_2' => item.billing_address_address_line_2,
                                    'billing_address_zip' => item.billing_address_zip,
                                    'billing_address_city' => item.billing_address_city,
                                    'billing_address_country' => item.billing_address_country,
                                    "fee_cents" => fee,
