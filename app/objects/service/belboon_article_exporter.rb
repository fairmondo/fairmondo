class BelboonArticleExporter
  ...
  EXPORT_MAPPING = {
    ...
    'Image_Large_URL' => "'https://www.fairmondo.de/' + title_image_url(:original)",
    'Image_Large_HEIGHT' => "title_image ? Paperclip::Geometry.from_file(title_image.image).height.to_i : 282",
    'Image_Large_WIDTH' => "title_image ? Paperclip::Geometry.from_file(title_image.image).width.to_i : 406",
    'Keywords' => nil,
